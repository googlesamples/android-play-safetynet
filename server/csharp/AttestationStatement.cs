...
namespace SafetyNetCheck
{
    ...
    public sealed class AttestationStatement
    {
        ...
        /// <summary>
        /// Whether or not the device was determined to have a CTS profile match.
        /// </summary>
        ...
        /// </summary>
        /// <param name="claims">The claims retrieved from an attestation statement string.</param>
        public AttestationStatement(Dictionary<string, string> claims)
        {
            ...
            if (claims.ContainsKey("timestampMs"))
            {
                ...
                long.TryParse(claims["timestampMs"], NumberStyles.Integer, CultureInfo.InvariantCulture,
            ...
            if (claims.ContainsKey("ctsProfileMatch"))
            {
                ...
                bool.TryParse(claims["ctsProfileMatch"], out ctsProfileMatchLocal);
            ...
            if (claims.ContainsKey("basicIntegrity"))
            {
                ...
                bool.TryParse(claims["basicIntegrity"], out basicIntegrityLocal);
