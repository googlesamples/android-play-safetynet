...
namespace SafetyNetCheck
{
    ...
    /// You must add your API key for the Android Device Verification API,
    /// otherwise all requests will fail.
    /// Remember that online verification should be used for testing only, and
    ...
    public static class OnlineVerify
    {
        ...
        /// and add it here.
        /// </summary>
        private static string ApiKey = "ADD_API_KEY_HERE";
